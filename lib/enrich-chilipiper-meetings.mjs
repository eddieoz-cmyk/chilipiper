...
export function enrichMeetingsWithRouting(meetings, rulesIndex, usersIndex) {
  for (const m of meetings) {
    ...
    if (m.assignedUser?.name && !m.hostUser?.name && m.meetingType === "concierge") {
...
export async function enrichChilipiperMeetingsPayload(payload, paths) {
  ...
  payload.dataSources = {
    calendar: {
      ...
      description:
        "Unified export: Concierge, Handoff, and ChiliCal meetings with routing and assignment fields.",
    },
  };
